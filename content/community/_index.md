...
Mehrmals im Jahr gibt es **Hacking Weekends** in
[Karlsruhe](https://wiki.openstreetmap.org/wiki/Template:HackWeekendKarlsruhe)
und [Berlin]().
...
* [Deutsche Startseite](https://wiki.openstreetmap.org/wiki/Hauptseite)
* [Englische Startseite](https://wiki.openstreetmap.org/)
...
zulegen. Wenn Du Lust hast, etwas beizutragen, aber nicht weißt, wo Du anfangen
sollst: Wir brauchen immer Leute, die helfen englischsprachige Wiki-Seiten ins
Deutsche zu übersetzen bzw. die Übersetzungen zu aktualisieren.
...
{{< rawhtml >}}
<img src="/img/fossgis-logo.png" title="FOSSGIS e.V." style="float: right; margin-left: 10px; width: 200px;"/>
{{< /rawhtml >}}
...
e.V.](https://www.fossgis.de/), einen gemeinnützigen Verein, der sich für freie
Software im Geo-Bereich und für freie Geodaten einsetzt. Er ist das „local
chapter“ der [OpenStreetMap Foundation](https://osmfoundation.org/), die das
Projekt weltweit vertritt.

Der FOSSGIS betreibt auch diese Webseiten und stellt verschiedene Dienste
für die OSM-Community zur Verfügung.

Auch ohne Mitglied zu sein, kann jede und jeder sich im FOSSGIS e.V.
engagieren. Wir freuen uns aber auch über neue Mitglieder!
